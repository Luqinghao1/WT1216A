...
void ModelWidget1::initChart() {
    ...
    m_plotTitle = new QCPTextElement(m_plot, "复合页岩油储层试井曲线 (模型1)", QFont("SimHei", 14, QFont::Bold));
...
void ModelWidget1::setupConnections() {
    ...
    connect(ui->btnExportData, &QPushButton::clicked, this, &ModelWidget1::onExportData);
    connect(ui->btnExportImage, &QPushButton::clicked, this, &ModelWidget1::onExportImage);
    ...
    connect(ui->checkShowPoints, &QCheckBox::toggled, this, &ModelWidget1::onShowPointsToggled);
}
...
void ModelWidget1::onResetView() { m_plot->rescaleAxes(); m_plot->replot(); }
...
void ModelWidget1::onChartSettings() { ChartSetting1 dlg(m_plot, m_plotTitle, this); dlg.exec(); }

void ModelWidget1::onShowPointsToggled(bool checked) {
...
void ModelWidget1::runCalculation() {
    ...
    QString resultTextHeader = "计算完成 (模型1)\n";
    ...
    emit calculationCompleted("Model1_Composite_VariableStorage", baseParams);
}
...
void ModelWidget1::onExportData() {
...
void ModelWidget1::onExportImage() {
